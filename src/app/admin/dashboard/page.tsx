            ...
            {(['Day', 'Week', 'Month'] as StatsFilter[]).map((f) => (
              <Button
                ...
                className={cn(
                  ...
                  dateFilter === f ? "bg-primary text-primary-foreground shadow-md" : "text-muted-foreground hover:text-foreground"
                )}
              >
                {f}
              </Button>
        ...
        <CardHeader className="p-12 pb-0 flex flex-col xl:flex-row xl:items-center justify-between gap-10">
          <div className="space-y-2">
            <div className="flex items-center gap-3">
              ...
              <CardTitle className="text-3xl font-black text-foreground">Live Activity Stream</CardTitle>
            </div>
                  ...
                  <TableRow key={v.id} className="border-b border-white/5 hover:bg-white/5 transition-all duration-300 group">
                    ...
                    <TableCell>
                      <div className="space-y-1.5">
                        <div className="text-sm font-black text-foreground/90 tracking-tight">{v.department}</div>
