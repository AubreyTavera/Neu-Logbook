      ...
      <div className="min-h-[80vh] flex items-center justify-center p-6 animate-in zoom-in-95 duration-700">
        <div className="max-w-xl w-full glass-card rounded-[4rem] p-16 text-center space-y-10 relative overflow-hidden border-white/5">
          ...
          <div className="space-y-4">
            <h2 className="text-5xl font-black text-foreground tracking-tighter">Check-in Verified</h2>
          ...
          <Button className="w-full h-16 bg-primary text-primary-foreground font-black rounded-2xl shadow-lg text-lg uppercase tracking-widest active:scale-95 transition-all" onClick={() => setSubmitted(false)}>
            Return to Dashboard
          </Button>
        </div>
      </div>
    ...
    <div className="max-w-7xl mx-auto space-y-12 animate-in fade-in slide-in-from-bottom-8 duration-700 pb-20">
      <div className="flex flex-col gap-4">
        <div className="flex items-center gap-4">
          <Badge className="bg-primary text-primary-foreground px-5 py-2 font-black text-[10px] uppercase tracking-[0.2em] rounded-full">Secure Entry</Badge>
        ...
        <h1 className="text-6xl font-black text-foreground tracking-tighter leading-none">Log Your Visit</h1>
        <p className="text-muted-foreground text-xl font-medium leading-relaxed max-w-2xl">
          Authenticated as <span className="text-foreground font-black underline decoration-primary underline-offset-8 decoration-4">{currentUser?.name}</span>. Verify your current campus activity below.
        </p>
      </div>
      ...
      <div className="grid lg:grid-cols-5 gap-12">
          ...
          <Card className="glass-card rounded-[3.5rem] border-white/5 shadow-2xl">
            <CardHeader className="p-12 pb-0">
              <div className="flex items-center gap-4 mb-2">
                ...
                <CardTitle className="text-3xl font-black text-foreground">Entry Manifest</CardTitle>
              </div>
            ...
            <CardContent className="p-12 space-y-10">
              <form onSubmit={handleSubmit} className="space-y-10">
                ...
                <Button type="submit" className="w-full h-20 bg-primary hover:bg-primary/90 text-primary-foreground text-xl font-black rounded-[2rem] shadow-lg transition-all group active:scale-[0.98]" disabled={loading}>
                  {loading ? (
                    <div className="flex items-center gap-4">
        ...
        <div className="lg:col-span-2 space-y-10">
          <Card className="bg-primary text-primary-foreground border-none shadow-xl rounded-[3rem] overflow-hidden group">
